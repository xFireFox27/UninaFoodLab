...
VALUES 
    ('Corso di cucina italiana', 'Ogni giorno', 100, 2025, '2025-07-08', (SELECT idTopic FROM Topic WHERE Nome = 'Cucina Italiana'), 'KenIlGuerriero'),
    ...
    ('Corso di cucina giapponese', 'Settimanale', 30, 2025, '2025-07-10', (SELECT idTopic FROM Topic WHERE Nome = 'Cucina Giapponese'), 'ChefLuca'),
    ('Corso di cucina indiana', 'Settimanale', 25, 2025, '2025-09-15', (SELECT idTopic FROM Topic WHERE Nome = 'Cucina Indiana'), 'ChefChristian'),
    ...
    ('Corso di cucina mediterranea', 'Ogni giorno', 100, 2025, '2025-07-25', (SELECT idTopic FROM Topic WHERE Nome = 'Cucina Mediterranea'), 'ChefAlessandro'),
