...
\begin{document}
    ...
    \begin{table}[h]
        ...
        \hline
        È iscritto a & Associa un utente a un corso a cui è iscritto & Utente, Corso \\
        \hline
        ...
        \hline
        È composta da & Associa una ricetta a un ingrediente che la compone & Ricetta, Ingrediente \\
        \hline
