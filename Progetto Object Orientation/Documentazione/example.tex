...
\begin{document}
    ...
    report deve fornire una rappresentazione grafica dei dati. Il sistema deve permettere allo chef di inserire delle notifiche relative ai 
    propri corsi, in caso di modifiche, come cambio di data o ora di una sessione oppure la sua 
